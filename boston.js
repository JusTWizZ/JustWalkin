function Sonido(){
    ...
    vid.setAttribute("src","https://www.youtube.com/embed/JB0A8Me8EKk?autoplay=1&mute=0&controls=0&start=60&rel=0&showinfo=0&modestbranding:1&disablekb=0")
    vid1.setAttribute("onclick","Silenciar()");
}
function Silenciar(){
    var vid = document.getElementById("video2");
    var vid1 = document.getElementById("switch-label1")
    vid.setAttribute("src","https://www.youtube.com/embed/JB0A8Me8EKk?autoplay=1&mute=1&controls=0&start=60&rel=0&showinfo=0&modestbranding:1&disablekb=0")
